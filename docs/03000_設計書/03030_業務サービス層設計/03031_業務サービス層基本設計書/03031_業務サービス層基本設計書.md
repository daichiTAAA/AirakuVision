...
### 4.2.5. sequence_validation_results
| 列名          | 型          | キー種別 | 説明                                        |
| ------------- | ----------- | -------- | ------------------------------------------- |
...
### 4.3.4. device_month_serial_logs
| 列名            | 型                       | キー種別 | 説明                         |
| --------------- | ------------------------ | -------- | ---------------------------- |
...
### 4.4.4. notification_preferences
| 列名            | 型                       | キー種別 | 説明                         |
| --------------- | ------------------------ | -------- | ---------------------------- |
