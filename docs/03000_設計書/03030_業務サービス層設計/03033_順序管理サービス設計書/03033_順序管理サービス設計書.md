...
| テーブル | 主キー | 主な項目 | 説明 |
|----------|--------|----------|------|
| production_sequences | sequence_id (UUID) | instruction_date, line_id, process_code, product_code, variant_code, month_serial, planned_start_at, planned_end_at, status, priority, remarks | 順序基本情報。|
