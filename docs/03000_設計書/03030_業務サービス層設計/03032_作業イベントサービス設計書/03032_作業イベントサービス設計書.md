...
| work_event_metadata | event_id | recording_id, sequence_id, process_code, product_code, machine_no, instruction_date, month_serial, binding_status, anomaly_flag | 録画動画と生産順序メタを紐付ける拡張メタデータ。|
