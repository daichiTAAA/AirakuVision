...
| work_event_metadata | event_id | recording_id, sequence_id (nullable), binding_status, anomaly_flag, linked_at | 録画動画と作業イベントの紐付け状態を保持（詳細メタは production_sequences を参照）。|
